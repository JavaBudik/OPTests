		...
		<div id="page">
			...
			<div id="content">
				<div class="post">
					...
					<div class="entry">
						<center> <b> Максимальна кількість балів: <c:out
								value="${maxBall}" /> <BR /> Максимальна оцінка 100 <br />
						</b>
						<br/>
						<form action="test.htm" method="post">
							<input type="hidden" name="xml" value="${testUrl}" />
							<input type="submit" value="Почати тестування"/>
						</form>
					</div>
					</center>
				</div>
