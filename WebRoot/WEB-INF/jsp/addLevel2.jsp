	...
	<body>
		...
		<div id="page">
					...
					<div class="content">
						<ul>
							...
							<li>
								...
								<br />
							<li>
								<a href="statForAdmin.htm"><strong>Результати
										тестувань</strong> </a>
								<br />
							<li>
								...
								<br />
							<li>
								<a href="allusers.htm"><strong>Інформація про
										студентів</strong> </a>
								<br />
							<li>
			...
			<div id="content">
				<div class="post">
					<h2 class="title">
						Формування питання з довільною кількістю правильних варіантів
						відповіді
					</h2>
					<div class="entry">
						<center>
						<form:form>
							<table border=1 class="tableHoriz">
								...
								<tr>
									<td class="header">
										Введіть к-ть балів за правильну відповідь
										<br />
									</td>
									<td width="150" class="header">
								...
								<tr>
									<td class="header">
										Які з цих варіантів правильні?
									</td>
									<td width="150">
										<form:checkbox path="check1" value="1" /> Перший
										<br />
										<form:checkbox path="check2" value="1" /> Другий
										<br />
										<form:checkbox path="check3" value="1" /> Третій
										<br />
										<form:checkbox path="check4" value="1" /> Четвертий
										<br />
										<form:checkbox path="check5" value="1" /> П'ятий
										<br />
									</td>
								</tr>
							</table>
							<tr>
								...
								<br />
								<br/>
								Перейти до питань першого рівня
								<form:checkbox path="level2" value="1" />
