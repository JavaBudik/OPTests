...
public class SaxTestList extends DefaultHandler {
	private List<TestList> list = new ArrayList<TestList>();
	...
	public void startElement(String namespaceURI, String localName,
		...
		if(!rawName.equals("tests")){
		if (attrs != null) {
				TestList oneTest = new TestList();
				oneTest.setName(attrs.getValue(0));
				oneTest.setLink(attrs.getValue(1));
				list.add(oneTest);
		}
		}
	...
	public List<TestList> getList(String uri) {
		parseURI(uri);
		return list;
	}
}
